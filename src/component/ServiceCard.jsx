...
export default function ServiceCard({ service }) {
  return (
    <div className="group bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 border border-slate-100 flex flex-col h-full">
      {/* 🔹 ইমেজ সেকশন (Hover Zoom) */}
      <div className="relative h-56 overflow-hidden">
        <Image
          src={service.image}
          alt={service.title}
          width={500} // এখানে ৫০০০ পিক্সেল দিতে পারেন, যা কার্ডের জন্য যথেষ্ট
          height={300} // উচ্চতা দিয়ে দিন
          className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
          // যদি এক্সটার্নাল ইউআরএল (Unsplash) ব্যবহার করেন, তবে next.config.js এ ডোমেইন অ্যাড থাকতে হবে
        />
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="mt-auto pt-6 flex items-center justify-between border-t border-slate-50">
          ...
          <Link
            ...
            // এখানে 'group/btn' ব্যবহার করেছি যাতে বাটন হোভার আলাদাভাবে হ্যান্ডেল করা যায়
            className="flex items-center justify-center w-12 h-12 bg-slate-100 rounded-2xl transition-all duration-300 shadow-sm group-hover:bg-red-500 group-hover:shadow-red-500/40"
          >
            <FaArrowRight className="text-slate-900 transition-colors duration-300 group-hover:text-white text-lg" />
          </Link>
        </div>
      </div>
    </div>
